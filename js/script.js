...
window.onload = function() {
    ...
    var getDimentions = function(elements) {
        ...
        elements.message.style.display = 'none'; // Kembalikan ke none setelah pengukuran
        return {
            loading: {
                w: '4rem', // Ukuran lebar loading dots
                h: '2.25rem' // Ukuran tinggi loading dots
            },
            bubble: {
    ...
    var sendMessage = function(message, position) {
        ...
        messagesEl.appendChild(document.createElement('br')); // Tambah <br> untuk spasi antar bubble

        // Mengukur dimensi setelah elemen ditambahkan ke DOM
        var dimensions = getDimentions(elements);

        // Set properti awal untuk animasi
        elements.message.style.display = 'block'; // Tampilkan pesan untuk pengukuran
        ...
        // Scroll ke bawah jika konten melampaui tinggi container
        ...
        // Animasi ukuran bubble saat loading
        ...
        // Setelah loading selesai, tampilkan pesan
        setTimeout(function() {
            loadingLoop.pause();
            dotsPulse.restart({
                opacity: 0,
    ...
    var sendMessages = function() {
        ...
        if (!message) return; // Hentikan jika tidak ada pesan lagi
        sendMessage(message);
        ++messageIndex;
        // Delay antara pengiriman pesan disesuaikan dengan panjang pesan
        setTimeout(sendMessages, (message.replace(/<(?:.|\n)*?>/gm, '').length * typingSpeed) + anime.random(900, 1200));
    }

    // Mulai pengiriman pesan saat halaman dimuat
    sendMessages();
